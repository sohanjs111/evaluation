...
if __name__ == '__main__':
        ...
        static_transformStamped4.transform.translation.x = 0.325-0.00010341352754
	...
	static_transformStamped5.header.frame_id = "camera_link" 
        ...
        #for evo including the transform from mount to camera_link which is 0.0 0.0175 0.0125
        static_transformStamped7.transform.translation.x = -0.00010341352754
        static_transformStamped7.transform.translation.y = 0.0149604650214
        static_transformStamped7.transform.translation.z = 0.000170986939338
        static_transformStamped7.transform.rotation.x = -0.00894242804497
        static_transformStamped7.transform.rotation.y = 0.00165949144866
        static_transformStamped7.transform.rotation.z = 0.00163967593107
        static_transformStamped7.transform.rotation.w = 0.99995726347
 	...
 	static_transformStamped8.header.frame_id = "camera_link"
        ...
        static_transformStamped8.transform.rotation.x = -0.5
        static_transformStamped8.transform.rotation.y = 0.5
        static_transformStamped8.transform.rotation.z = -0.5
        static_transformStamped8.transform.rotation.w = 0.5
        static_transformStamped6 = geometry_msgs.msg.TransformStamped()
        static_transformStamped6.header.frame_id = "base_footprint"
        static_transformStamped6.child_frame_id = "mv_25003609" 
        static_transformStamped6.transform.translation.x = 0.0
        static_transformStamped6.transform.translation.y = 0.0
        static_transformStamped6.transform.translation.z = 0.08
        static_transformStamped6.transform.rotation.x = -0.707106781185
        static_transformStamped6.transform.rotation.y = 0.707106781188
        static_transformStamped6.transform.rotation.z = 0
        static_transformStamped6.transform.rotation.w = 0
	static_transformStamped9 = geometry_msgs.msg.TransformStamped()
        static_transformStamped9.header.frame_id = "base_footprint"
        static_transformStamped9.child_frame_id = "laser_front" 
        static_transformStamped9.transform.translation.x = 0.35
        static_transformStamped9.transform.translation.y = -0.26
        static_transformStamped9.transform.translation.z = 0.06
        static_transformStamped9.transform.rotation.x = 0.0
        static_transformStamped9.transform.rotation.y = 0.0
        static_transformStamped9.transform.rotation.z = -0.39497015
        static_transformStamped9.transform.rotation.w = 0.9186395
	#same transform as static_transformStamped6 we just publish this for our own algorithms mv_25003609 
        static_transformStamped10 = geometry_msgs.msg.TransformStamped()
        static_transformStamped10.header.frame_id = "base_footprint"
        static_transformStamped10.child_frame_id = "camera_floor" 
        static_transformStamped10.transform.translation.x = 0.0
        static_transformStamped10.transform.translation.y = 0.0
        static_transformStamped10.transform.translation.z = 0.08
        static_transformStamped10.transform.rotation.x = -0.707106781185
        static_transformStamped10.transform.rotation.y = 0.707106781188
        static_transformStamped10.transform.rotation.z = 0
        static_transformStamped10.transform.rotation.w = 0
	...
	if int(writetobag) == 1:
			...
			for topic, msg, t in rosbag.Bag(in_bag2).read_messages():
			   ...
			   if topic == "tf_static" and msg.transforms:
				...
				for i in range(len(msg.transforms)): 
					...
					static_transformStamped6.header.stamp=t
		...
		broadcaster = tf2_ros.StaticTransformBroadcaster()  
        	...
        	static_transformStamped10.header.stamp = rospy.Time.now()   	
		...
		static_transformStamped6,static_transformStamped9,static_transformStamped10])       	
